...
# reset hard lagclear active variable
execute if score $lagclear.time irsc.aeo.global matches 1 run scoreboard players set $lagclear.hard.active irsc.aeo.global 1
